...
<footer className="bg-[#169cc6]/80 font-sans dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2">
                <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">Subscribe our newsletter to get Car update.</h1>
        ...
        <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© Motoz Cars Store All rights reserved.</p>
    </div>
</footer>
        </div>
    );
