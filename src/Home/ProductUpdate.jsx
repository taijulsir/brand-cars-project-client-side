...
const ProductUpdate = () => {
    ...
    const handleUpdateProduct = e => {
        ...
        fetch(`https://new-brand-cars.vercel.app/brandNames/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div>
            <div className="container mx-auto mb-16 mt-20 bg-gradient-to-br from-sky-200 to-white shadow-lg">
                <h1 className="text-4xl font-bold text-center pt-12  text-lime-700">Update product</h1>
                    ...
                    <div className="lg:px-24 gap-6">
                        <div className="form-control">
                            ...
                            <label className="input-group">
                                ...
                                <input type="submit" value="Update Product" className="input btn bg-lime-600 input-bordered w-full px-4 py-3 outline-none rounded-lg mb-16  " />
                            </label>
                        </div>
