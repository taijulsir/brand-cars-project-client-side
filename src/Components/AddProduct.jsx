...
const AddProduct = () => {
    ...
    const handleAddProduct = e => {
        ...
        fetch("https://new-brand-cars.vercel.app/brandNames", {
            method: "POST",
            headers: {
    ...
    return (
        <div>
            ...
            {/* form section */}
            <div className=" container mx-auto mb-20 mt-20  bg-gradient-to-br from-sky-200 to-white shadow-lg">
                <div>
                    <h1 className="text-4xl font-bold text-center pt-12  text-lime-700">Add products</h1>
                    <p className="text-sm w-1/2 mx-auto text-center pt-2 mb-6 ">Complete the form below to add your automotive product </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2  lg:px-24 gap-6">
                            <div className="form-control">
                                ...
                                <label className="input-group">
                                    ...
                                    <input type="text" placeholder="Rating" name="rating" className="input input-bordered w-full px-4 py-3 outline-none rounded-lg  mb-5 " />
                                </label>
                            </div>
                            <div className="form-control">
                                <label className="label">
                        ...
                        <div className=" lg:px-24">
                            <div className="form-control">
                                ...
                                <label className="input-group">
                                    ...
                                    <input type="text" placeholder="Photo Url" name="brandImage" className="input input-bordered w-full px-4 py-3 outline-none rounded-lg  mb-10 " />
                                </label>
                            </div>
                        ...
                        <div className="lg:px-24 gap-6">
                            <div className="form-control">
                                ...
                                <label className="input-group">
                                    ...
                                    <input type="submit" value="Add Products" className="input btn bg-lime-600 input-bordered w-full px-4 py-3 outline-none rounded-lg mb-16  " />
                                </label>
                            </div>
